...
'''
    ...
    the minimum price to a very large number (sys.maxsize) and the maximum profit to 0. It then loops 
    through the prices, updating the minimum price if the current price is less than the current minimum 
